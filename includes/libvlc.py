    ...
    if sys.platform.startswith('linux'):
        ...
        if p is None:
            ...
            if plugin_path is None:
                ...
                for p in ('{programfiles}\\VideoLan{libname}',
        ...
        raise NotImplementedError(
            '%s: %s not supported' % (sys.argv[0], sys.platform))
...
class LogMessage(_Cstruct):
    ...
    def __str__(self):
        return '%s(%d:%s): %s' % (
        self.__class__.__name__, self.severity, self.type, self.message)
...
class ModuleDescription(_Cstruct):
    def __str__(self):
        return '%s %s (%s)' % (
        self.__class__.__name__, self.shortname, self.name)
...
class Instance(_Ctype):
        ...
        if head:
            ...
            while i:
                ...
                d = [{'id': libvlc_audio_output_device_id(self, i.name, d),
                      'longname': libvlc_audio_output_device_longname(self,
                                                                      i.name,
                                                                      d)}
                     for d in
                     range(libvlc_audio_output_device_count(self, i.name))]
    ...
    def set_user_agent(self, name, http):
        ...
        '''
        return libvlc_set_user_agent(self, str_to_bytes(name),
                                     str_to_bytes(http))
    ...
    def set_app_id(self, id, version, icon):
        ...
        '''
        return libvlc_set_app_id(self, str_to_bytes(id), str_to_bytes(version),
                                 str_to_bytes(icon))
    ...
    def vlm_add_broadcast(self, psz_name, psz_input, psz_output, i_options,
        ...
        return libvlc_vlm_add_broadcast(self, str_to_bytes(psz_name),
                                        ...
                                        str_to_bytes(psz_output), i_options,
                                        ppsz_options, b_enabled, b_loop)

    def vlm_add_vod(self, psz_name, psz_input, i_options, ppsz_options,
                    b_enabled, psz_mux):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_add_vod(self, str_to_bytes(psz_name),
                                  str_to_bytes(psz_input), i_options,
                                  ppsz_options, b_enabled,
    ...
    def vlm_set_output(self, psz_name, psz_output):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_set_output(self, str_to_bytes(psz_name),
    ...
    def vlm_set_input(self, psz_name, psz_input):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_set_input(self, str_to_bytes(psz_name),
                                    str_to_bytes(psz_input))
    ...
    def vlm_add_input(self, psz_name, psz_input):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_add_input(self, str_to_bytes(psz_name),
                                    str_to_bytes(psz_input))
    ...
    def vlm_set_mux(self, psz_name, psz_mux):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_set_mux(self, str_to_bytes(psz_name),
                                  str_to_bytes(psz_mux))

    def vlm_change_media(self, psz_name, psz_input, psz_output, i_options,
                         ppsz_options, b_enabled, b_loop):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_change_media(self, str_to_bytes(psz_name),
                                       str_to_bytes(psz_input),
                                       str_to_bytes(psz_output), i_options,
                                       ppsz_options, b_enabled, b_loop)
    ...
    def vlm_seek_media(self, psz_name, f_percentage):
        ...
        @return: 0 on success, -1 on error.
        '''
        return libvlc_vlm_seek_media(self, str_to_bytes(psz_name),
                                     f_percentage)
    ...
    def vlm_get_media_instance_time(self, psz_name, i_instance):
        ...
        '''
        return libvlc_vlm_get_media_instance_time(self, str_to_bytes(psz_name),
                                                  i_instance)
    ...
    def vlm_get_media_instance_rate(self, psz_name, i_instance):
        ...
        '''
        return libvlc_vlm_get_media_instance_rate(self, str_to_bytes(psz_name),
                                                  i_instance)
    ...
    def media_new_callbacks(self, open_cb, read_cb, seek_cb, close_cb, opaque):
        ...
        @version: LibVLC 3.0.0 and later.
        '''
        return libvlc_media_new_callbacks(self, open_cb, read_cb, seek_cb,
                                          close_cb, opaque)
...
class Media(_Ctype):
    ...
    def add_option_flag(self, psz_options, i_flags):
        ...
        '''
        return libvlc_media_add_option_flag(self, str_to_bytes(psz_options),
                                            i_flags)
    ...
    def slaves_add(self, i_type, i_priority, psz_uri):
        ...
        @version: LibVLC 3.0.0 and later.
        '''
        return libvlc_media_slaves_add(self, i_type, i_priority,
                                       str_to_bytes(psz_uri))
...
class MediaPlayer(_Ctype):
    ...
    def get_full_title_descriptions(self):
        ...
        n = libvlc_media_player_get_full_title_descriptions(self, ctypes.byref(
            titleDescription_pp))
        info = ctypes.cast(ctypes.titleDescription_pp, ctypes.POINTER(
    ...
    def get_full_chapter_descriptions(self, i_chapters_of_title):
        ...
        info = ctypes.cast(ctypes.chapterDescription_pp, ctypes.POINTER(
    ...
    def video_set_format(self, chroma, width, height, pitch):
        ...
        '''
        return libvlc_video_set_format(self, str_to_bytes(chroma), width,
                                       height, pitch)
    ...
    def audio_set_callbacks(self, play, pause, resume, flush, drain, opaque):
        ...
        @version: LibVLC 2.0.0 or later.
        '''
        return libvlc_audio_set_callbacks(self, play, pause, resume, flush,
                                          drain, opaque)
    ...
    def audio_set_format(self, format, rate, channels):
        ...
        @version: LibVLC 2.0.0 or later.
        '''
        return libvlc_audio_set_format(self, str_to_bytes(format), rate,
                                       channels)
    ...
    def add_slave(self, i_type, psz_uri, b_select):
        ...
        '''
        return libvlc_media_player_add_slave(self, i_type,
                                             str_to_bytes(psz_uri), b_select)
    ...
    def video_take_snapshot(self, num, psz_filepath, i_width, i_height):
        ...
        return libvlc_video_take_snapshot(self, num,
                                          str_to_bytes(psz_filepath), i_width,
                                          i_height)
    ...
    def audio_output_device_set(self, module, device_id):
        ...
        '''
        return libvlc_audio_output_device_set(self, str_to_bytes(module),
                                              str_to_bytes(device_id))
...
def libvlc_event_attach(p_event_manager, i_event_type, f_callback, user_data):
    ...
    f = _Cfunctions.get('libvlc_event_attach', None) or \
        _Cfunction('libvlc_event_attach', ((1,), (1,), (1,), (1,),), None,
                   ctypes.c_int, EventManager, ctypes.c_uint, Callback,
                   ctypes.c_void_p)
    return f(p_event_manager, i_event_type, f_callback, user_data)


def libvlc_event_detach(p_event_manager, i_event_type, f_callback,
                        p_user_data):
    '''Unregister an event notification.
    ...
    f = _Cfunctions.get('libvlc_event_detach', None) or \
        _Cfunction('libvlc_event_detach', ((1,), (1,), (1,), (1,),), None,
                   None, EventManager, ctypes.c_uint, Callback,
                   ctypes.c_void_p)
...
def libvlc_log_get_context(ctx):
    ...
    f = _Cfunctions.get('libvlc_log_get_context', None) or \
        _Cfunction('libvlc_log_get_context', ((1,), (2,), (2,), (2,),), None,
                   None, Log_ptr, ListPOINTER(ctypes.c_char_p),
                   ListPOINTER(ctypes.c_char_p), ctypes.POINTER(ctypes.c_uint))
    return f(ctx)
...
def libvlc_media_discoverer_new(p_inst, psz_name):
    ...
    f = _Cfunctions.get('libvlc_media_discoverer_new', None) or \
        _Cfunction('libvlc_media_discoverer_new', ((1,), (1,),),
...
def libvlc_media_discoverer_list_get(p_inst, i_cat, ppp_services):
    ...
    f = _Cfunctions.get('libvlc_media_discoverer_list_get', None) or \
        _Cfunction('libvlc_media_discoverer_list_get', ((1,), (1,), (1,),),
                   None,
...
def libvlc_media_discoverer_list_release(pp_services, i_count):
    ...
    f = _Cfunctions.get('libvlc_media_discoverer_list_release', None) or \
        _Cfunction('libvlc_media_discoverer_list_release', ((1,), (1,),), None,
                   None, ctypes.POINTER(MediaDiscovererDescription),
                   ctypes.c_size_t)
...
def libvlc_vlm_add_broadcast(p_instance, psz_name, psz_input, psz_output,
    ...
    f = _Cfunctions.get('libvlc_vlm_add_broadcast', None) or \
        _Cfunction('libvlc_vlm_add_broadcast',
    ...
    return f(p_instance, psz_name, psz_input, psz_output, i_options,
             ppsz_options, b_enabled, b_loop)


def libvlc_vlm_add_vod(p_instance, psz_name, psz_input, i_options,
    ...
    f = _Cfunctions.get('libvlc_vlm_add_vod', None) or \
        _Cfunction('libvlc_vlm_add_vod',
                   ((1,), (1,), (1,), (1,), (1,), (1,), (1,),), None,
                   ctypes.c_int, Instance, ctypes.c_char_p, ctypes.c_char_p,
                   ctypes.c_int, ListPOINTER(ctypes.c_char_p), ctypes.c_int,
                   ctypes.c_char_p)
    return f(p_instance, psz_name, psz_input, i_options, ppsz_options,
             b_enabled, psz_mux)
...
def libvlc_vlm_change_media(p_instance, psz_name, psz_input, psz_output,
                            i_options, ppsz_options, b_enabled, b_loop):
    '''Edit the parameters of a media. This will delete all existing inputs and
    add the specified one.
    @param p_instance: the instance.
    ...
    f = _Cfunctions.get('libvlc_vlm_change_media', None) or \
        _Cfunction('libvlc_vlm_change_media',
                   ((1,), (1,), (1,), (1,), (1,), (1,), (1,), (1,),), None,
                   ctypes.c_int, Instance, ctypes.c_char_p, ctypes.c_char_p,
                   ctypes.c_char_p, ctypes.c_int, ListPOINTER(ctypes.c_char_p),
                   ctypes.c_int, ctypes.c_int)
...
def libvlc_media_new_callbacks(instance, open_cb, read_cb, seek_cb, close_cb,
                               opaque):
    '''Create a media with custom callbacks to read the data from.
    ...
    f = _Cfunctions.get('libvlc_media_new_callbacks', None) or \
        _Cfunction('libvlc_media_new_callbacks',
                   ((1,), (1,), (1,), (1,), (1,), (1,),), class_result(Media),
                   ctypes.c_void_p, Instance, MediaOpenCb, MediaReadCb,
                   MediaSeekCb, MediaCloseCb, ctypes.c_void_p)
...
def libvlc_media_parse_with_options(p_md, parse_flag, timeout):
    ...
    f = _Cfunctions.get('libvlc_media_parse_with_options', None) or \
        _Cfunction('libvlc_media_parse_with_options', ((1,), (1,), (1,),),
                   None,
...
def libvlc_renderer_discoverer_event_manager(p_rd):
    ...
    f = _Cfunctions.get('libvlc_renderer_discoverer_event_manager', None) or \
        _Cfunction('libvlc_renderer_discoverer_event_manager', ((1,),),
                   class_result(EventManager),
                   ctypes.c_void_p, ctypes.c_void_p)
    return f(p_rd)
...
def libvlc_renderer_discoverer_list_release(pp_services, i_count):
    ...
    f = _Cfunctions.get('libvlc_renderer_discoverer_list_release', None) or \
        _Cfunction('libvlc_renderer_discoverer_list_release', ((1,), (1,),),
                   None,
...
def libvlc_video_set_callbacks(mp, lock, unlock, display, opaque):
    ...
    f = _Cfunctions.get('libvlc_video_set_callbacks', None) or \
        _Cfunction('libvlc_video_set_callbacks',
                   ((1,), (1,), (1,), (1,), (1,),), None,
                   None, MediaPlayer, VideoLockCb, VideoUnlockCb,
                   VideoDisplayCb, ctypes.c_void_p)
...
def libvlc_video_set_format(mp, chroma, width, height, pitch):
    ...
    f = _Cfunctions.get('libvlc_video_set_format', None) or \
        _Cfunction('libvlc_video_set_format', ((1,), (1,), (1,), (1,), (1,),),
                   None,
                   None, MediaPlayer, ctypes.c_char_p, ctypes.c_uint,
...
def libvlc_video_set_format_callbacks(mp, setup, cleanup):
    ...
    f = _Cfunctions.get('libvlc_video_set_format_callbacks', None) or \
        _Cfunction('libvlc_video_set_format_callbacks', ((1,), (1,), (1,),),
                   None,
...
def libvlc_media_player_set_android_context(p_mi, p_awindow_handler):
    ...
    f = _Cfunctions.get('libvlc_media_player_set_android_context', None) or \
        _Cfunction('libvlc_media_player_set_android_context', ((1,), (1,),),
                   None,
                   None, MediaPlayer, ctypes.c_void_p)
...
def libvlc_audio_set_callbacks(mp, play, pause, resume, flush, drain, opaque):
    ...
    f = _Cfunctions.get('libvlc_audio_set_callbacks', None) or \
        _Cfunction('libvlc_audio_set_callbacks',
                   ((1,), (1,), (1,), (1,), (1,), (1,), (1,),), None,
                   None, MediaPlayer, AudioPlayCb, AudioPauseCb, AudioResumeCb,
                   AudioFlushCb, AudioDrainCb, ctypes.c_void_p)
...
def libvlc_audio_set_format_callbacks(mp, setup, cleanup):
    ...
    f = _Cfunctions.get('libvlc_audio_set_format_callbacks', None) or \
        _Cfunction('libvlc_audio_set_format_callbacks', ((1,), (1,), (1,),),
                   None,
...
def libvlc_media_player_get_chapter_count_for_title(p_mi, i_title):
    ...
    @return: number of chapters in title, or -1.
    '''
    f = _Cfunctions.get('libvlc_media_player_get_chapter_count_for_title',
                        None) or \
        _Cfunction('libvlc_media_player_get_chapter_count_for_title',
                   ((1,), (1,),), None,
...
def libvlc_media_player_add_slave(p_mi, i_type, psz_uri, b_select):
    ...
    f = _Cfunctions.get('libvlc_media_player_add_slave', None) or \
        _Cfunction('libvlc_media_player_add_slave', ((1,), (1,), (1,), (1,),),
                   None,
                   ctypes.c_int, MediaPlayer, MediaSlaveType, ctypes.c_char_p,
                   ctypes.c_bool)
...
def libvlc_media_player_get_full_title_descriptions(p_mi, titles):
    ...
    @version: LibVLC 3.0.0 and later.
    '''
    f = _Cfunctions.get('libvlc_media_player_get_full_title_descriptions',
                        None) or \
        _Cfunction('libvlc_media_player_get_full_title_descriptions',
                   ((1,), (1,),), None,
                   ctypes.c_int, MediaPlayer,
...
def libvlc_media_player_get_full_chapter_descriptions(p_mi,
                                                      i_chapters_of_title,
                                                      pp_chapters):
    '''Get the full description of available chapters.
    @param p_mi: the media player.
    ...
    @version: LibVLC 3.0.0 and later.
    '''
    f = _Cfunctions.get('libvlc_media_player_get_full_chapter_descriptions',
                        None) or \
        _Cfunction('libvlc_media_player_get_full_chapter_descriptions',
                   ((1,), (1,), (1,),), None,
                   ctypes.c_int, MediaPlayer, ctypes.c_int,
...
def libvlc_video_take_snapshot(p_mi, num, psz_filepath, i_width, i_height):
    ...
    f = _Cfunctions.get('libvlc_video_take_snapshot', None) or \
        _Cfunction('libvlc_video_take_snapshot',
                   ((1,), (1,), (1,), (1,), (1,),), None,
...
def libvlc_audio_output_device_list_get(p_instance, aout):
    ...
    f = _Cfunctions.get('libvlc_audio_output_device_list_get', None) or \
        _Cfunction('libvlc_audio_output_device_list_get', ((1,), (1,),), None,
                   ctypes.POINTER(AudioOutputDevice), Instance,
                   ctypes.c_char_p)
...
def libvlc_audio_equalizer_get_amp_at_index(p_equalizer, u_band):
    ...
    f = _Cfunctions.get('libvlc_audio_equalizer_get_amp_at_index', None) or \
        _Cfunction('libvlc_audio_equalizer_get_amp_at_index', ((1,), (1,),),
                   None,
...
def libvlc_media_list_player_get_media_player(p_mlp):
    ...
    f = _Cfunctions.get('libvlc_media_list_player_get_media_player', None) or \
        _Cfunction('libvlc_media_list_player_get_media_player', ((1,),),
                   class_result(MediaPlayer),
                   ctypes.c_void_p, MediaListPlayer)
    return f(p_mlp)
...
if __name__ == '__main__':
    ...
    if sys.argv[1:] and '-h' not in sys.argv[1:] and '--help' not in sys.argv[
                                                                     1:]:
